...
//        pagination config start
        ...
        $sql = "SELECT * FROM merk WHERE nm_merk LIKE '%$q%' ORDER BY nm_merk"; // query silahkan disesuaikan
        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                         <thead>
                            <tr>
								<th class="th">No</th>
                                <th class="th">ID Merk</th>
                                <th class="th">Nama Merk</th>
                                <th class="th">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while (($count < $rpp) && ($i < $tcount)) {
                                ...
                                <tr>
                                    ...
                                    <td width="120px" class="text-center">
										<a href=mutakhir_supplier.php?data=<?php echo $data ['id_merk']; ?>><button type="button" class="btn btn-info" > <span class="glyphicon glyphicon-pencil"></span></button></a>
                                        <a href=hapus_supplier.php?data=<?php echo $data ['id_merk']; ?>><button type="button" class="btn btn-danger" onClick="return confirm('Apakah anda akan menghapus data ini?');"  ><span class="glyphicon glyphicon-trash"></span></button></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href=form_supplier.php> <input class="btn btn-primary"  type=button value="+ Tambah Data Merk"></a>
                </div>
            </div>
        </div> <!-- container -->
    </body>
