...
$hasil=mysqli_query($conn, "SELECT MAX(no_trx) AS maxID FROM No_trx");
...
<div id="container">
    <div id="header"> 
     ...
     <form action="dlt_trx.php">
        <button type="submit" class="btn btn-Danger btn-block btn-lg">Transaksi Baru</button>
    </form>
    <br/>   <br/>
   ...
   <!-- Update No transaksi -->
<?php
   $sql = mysqli_query ($conn, "SELECT no_trx FROM No_trx where id = '1' ");
   $data = mysqli_fetch_array ($sql);
   $tambah = $data['no_trx']+1;
   $sql1 = mysqli_query ($conn, "UPDATE No_trx set no_trx = '$tambah' where id = '1'  ");
?>
