...
$query  = mysqli_query ($conn, "SELECT *FROM baju where id_baju = '$id'");
...
<input type="hidden" name="tgl_trx" value="<?php echo $tgl; ?>" >	
	<tr>
		<th>  ID Baju</th> <th> Nama Baju</th> 
		<th> Harga Asal</th> <th>Harga Jual</th> <th> Jumlah</th> <th></th>
	</tr>	
	  <tr> 
		 <td>
    <input type="text" class="form-control input-sm" name="id_baju" size="10" value="<?php echo $data['id_baju'];?>" ReadOnly>
        </td>
        <td>
    <input type="text" class="form-control input-sm" name="nama_baju" size="30" value="<?php echo $data['nama_baju'];?>" ReadOnly>
	  </td>	
     <td>
...
<table class="table">
	<tr>
		<th>No.</th><th>Nama Baju</th> <th>Harga Baju</th> <th>Jumlah</th> <th>Jumlah Harga</th>
	</tr>
