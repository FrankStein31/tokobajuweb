...
<form action="#" method="POST">
	<tr>
	  ...
	  <tr> 
		 <td>
    <input type="text" class="form-control input-sm" name="id_baju"  ReadOnly>
        </td>
        <td>
    <input type="text" class="form-control input-sm" name="nama_baju" size="15"  ReadOnly>
	  </td>	
     <td>
...
<table class="table" >
	<tr>
		<th>No.</th><th>Nama Baju</th> <th>Harga Baju</th> <th width="150px">Jumlah</th> <th>Jumlah Harga</th>
	</tr>
