...
<body>
    ...
    $sql = "SELECT b.*, m.nm_merk FROM baju b LEFT JOIN merk m ON b.id_merk = m.id_merk WHERE b.nama_baju LIKE '%$q%' OR b.id_baju LIKE '%$q%' ORDER BY b.nama_baju"; // query silahkan disesuaikan
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th class="th">No</th>
                        <th class="th">ID Baju</th>
                        <th class="th">Nama Baju</th>
                        <th class="th">Jenis Baju</th>
                    ...
                    while (($count < $rpp) && ($i < $tcount)) {
                        ...
                        <tr class="tr">
                            ...
                            <td>
                                <?php echo $data['id_baju']; ?>
                            </td>
                            <td>
                                <?php echo $data['nama_baju']; ?>
                            </td>
                            <td>
                                <?php echo $data['jenis_baju']; ?>
                            </td>
                            <td>
                            ...
                            <!-- <td> -->
                                <!-- // if (!empty($data['foto'])) { -->
                                <!-- //     echo '<img src="data:image/jpeg/jpg;base64,' . base64_encode($data['foto']) . '" width="100" height="100" />'; -->
                                <!-- // } else { -->
                            ...
                            <td width="150px" class="text-center">
                                <div class="btn-group btn-group-justified">
                                    <a href=cetak_barcode.php?data=<?php echo $data['id_baju']; ?>><button
                                                type="button" class="btn btn-default"> <span
                                                    class="glyphicon glyphicon-barcode"></span></button></a>
                                    <a href=mutakhir_barang.php?data=<?php echo $data['id_baju']; ?>><button
                                                type="button" class="btn btn-info"> <span
                                                    class="glyphicon glyphicon-pencil"></span></button></a>
                                    <a href=hapus_barang.php?data=<?php echo $data['id_baju']; ?>><button
                                                type="button" class="btn btn-danger"
                                                onClick="return confirm('Apakah anda akan menghapus barang ini?');"><span
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href=form_barang.php> <input class="btn btn-primary" type=button value="+ Tambah Data Baju"></a>
            </div>
        </div>
    </div> <!-- container -->
</body>
